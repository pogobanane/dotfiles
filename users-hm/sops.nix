...
let
  cfg = config.sops;
  sops-install-secrets = (pkgs.callPackage ../.. {}).sops-install-secrets; # TODO this package obviousely only exists upstream https://github.com/Mic92/sops-nix/blob/feat/home-manager/modules/home-manager/sops.nix
  ...
  config = lib.mkIf (cfg.secrets != {}) {
    ...
    systemd.user.services.sops-nix = {
      ...
      Service = {
        ...
        Type = "oneshot";
        ExecStart = toString (pkgs.writeShellScript "sops-nix-user" 
